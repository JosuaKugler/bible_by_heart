...
class ScrollablePositionedList extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _ScrollablePositionedListState(scrollController);
}
...
class ItemScrollController {
  ...
  bool get isAttached => myScrollableListState != null;

  _ScrollablePositionedListState myScrollableListState;
  ...
  void jumpTo({@required int index, double alignment = 0}) {
    myScrollableListState._jumpTo(index: index, alignment: alignment);
  }
  ...
  Future<void> scrollTo(
    ...
    assert(myScrollableListState != null);
    return myScrollableListState._scrollTo(
      index: index,
      alignment: alignment,
      duration: duration,
      curve: curve,
  ...
  void _attach(_ScrollablePositionedListState scrollableListState) {
    assert(myScrollableListState == null);
    myScrollableListState = scrollableListState;
  }

  void _detach() {
    assert(myScrollableListState != null);
    myScrollableListState = null;
  }
}
...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  ScrollController frontScrollController; // = ScrollController(keepScrollOffset: false);
  ...
  void _jumpTo({@required int index, double alignment}) {
    ...
    if (_showFrontList) {
      frontScrollController.jumpTo(0.0);
      setState(() {
        frontTarget = index;
